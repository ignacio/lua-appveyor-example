...
set PATH=%PATH%;C:\Program Files (x86)\LuaRocks\%LUAROCKS_SHORTV%
echo %PATH%
set LUA_PATH="C:\Program Files (x86)\LuaRocks\%LUAROCKS_SHORTV%\lua\?.lua;C:\Program Files (x86)\LuaRocks\%LUAROCKS_SHORTV%\lua\?\init.lua;C:\Program Files (x86)\LuaRocks\systree\share\lua\%LUA_SHORTV%\?.lua;C:\Program Files (x86)\LuaRocks\systree\share\lua\%LUA_SHORTV%\?\init.lua"
